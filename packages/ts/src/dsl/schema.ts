...
interface StringsOpts extends SchemaOpts<string> {
  ...
  /** Declares the schema of content embedded inside this string value. */
...
export const isoDuration = (opts?: Omit<StringsOpts, "examples" | "format">): Str =>
  string({
    ...opts,
...
export const httpURL = (opts?: Omit<StringsOpts, "format" | "pattern">): Str =>
  string({
    ...opts,
    format: "uri",
    pattern: "^https?://\\S+$",
